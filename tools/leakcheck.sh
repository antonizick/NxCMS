...
scan FAIL "origin shell user / home path" '/home/antonizi|antonizi@'
scan FAIL "origin hosting server"         'server284'
scan FAIL "origin database name"          'antonizi_portal'
scan FAIL "origin live hostname"          'portal\.antonizick\.com'
scan FAIL "origin SSH key name"           'antonizick_portal|\.ssh/'
